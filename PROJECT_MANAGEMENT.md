...
| M1.3 | Guardrails & Intent/Need Extraction | C | M1.0 | Vietnamese request becomes validated need | Story packet, unit proof, trace | ✅ Done |
| M1.4 | State, Clarification, Routing & Persistence | C/D | M1.0 | Multi-turn clarification resumes by session | Story packet, unit/integration proof, trace | 🟨 In progress |
...
- [x] M1.3 guarded structured need extraction
...
> **Status legend:** ⬜ planned | 🟨 in_progress | 🟦 blocked | ✅ implemented

| Story ID | Title | Milestone | Lane | Priority | Status |
|---|---|---|---|---|---|
| US-101 | Request/session/trace gateway | M1.5 | D | P0 | ⬜ planned |
| US-102 | Layered input guardrail | M1.3 | C | P0 | ✅ implemented |
| US-103 | Vietnamese intent and need extraction | M1.3 | C | P0 | ✅ implemented |
| US-104 | State merge and correction precedence | M1.4 | C/D | P0 | ✅ implemented |
