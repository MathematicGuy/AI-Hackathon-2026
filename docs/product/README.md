...
The `air-conditioner-advisor-m1-*` documents below are the **Milestone 1 (Air-Conditioner slice) artifacts**, scoped to air conditioners (máy lạnh) as the first vertical slice
