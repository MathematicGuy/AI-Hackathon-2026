...
| `docs/product/air-conditioner-advisor-m1-contract.md` | Accepted Milestone 1 product behavior | Primary product authority unless an Accepted ADR explicitly supersedes a named part | Stable compatibility path in this phase | Product contract owner | Before any advisor behavior change |
